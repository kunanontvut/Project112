...
class typingerror : public exception
{
public:
    virtual const char *what() const throw()
    {
        return "Error!! plese input Integer";
    }
};
...
int main()
{
    ...
    do
    {
        if (P1.returnscore() == 3 || P2.returnscore() == 3)
            break;
        if (P1.returnsize() <= 0 || P2.returnsize() <= 0)
            break;
        cout << "!! ";
        ...
        cout << endl;
        changetextcolor(P1.returnname(), 9);
        cout << " Score -> " << P1.returnscore();
        if (P1.returnscore() == 3)
            changetextcolor(" WINER ", 10);
        cout << endl;
        changetextcolor(P2.returnname(), 12);
        cout << " Score -> " << P2.returnscore();
        if (P2.returnscore() == 3)
            changetextcolor(" WINER ", 10);
        cout << endl;
        changetextcolor("===============================================================", 7);
...
void pregame_display()
{
    ...
    cout << "   ------- ";
    changetextcolor("Aves", 7);
    cout << " <---------     "
         << "     "
         << "   ----- ";
    changetextcolor("Primitive", 5);
    cout << " <------     " << endl;
    cout << "   V                     |     "
         << "     "
         << "   V                     |     " << endl;
    changetextcolor("Reptilia", 2);
    cout << "           ";
    changetextcolor("  Terrestail", 6);
    cout << " "
         << "     "
         << " ";
    changetextcolor(" Aves", 7);
    cout << "                ";
    changetextcolor("Repptilia", 2);
    cout << endl;
    cout << "   V                     ^     "
         << "     "
         << "   V                     ^     " << endl;
    changetextcolor("Aquatic", 11);
    cout << " ------------>";
    changetextcolor("Primitive", 5);
    cout << " "
         << "     ";
    changetextcolor("Aquatic", 11);
    cout << " ------------>";
    changetextcolor("Terrestial", 6);
    cout << endl;
    cout << "|Monster Element|  (Win -> Lose)" << endl;
    cout << "  ----- ";
    changetextcolor("Wind", 11);
    cout << " <------   "
         << "     "
         << "  ----- ";
    changetextcolor("Water", 3);
    cout << "<------  " << endl;
    cout << "  V                |   "
         << "     "
         << "  V                |   " << endl;
    changetextcolor("Fire", 12);
    cout << "             ";
    changetextcolor("Earth", 14);
    cout << "     ";
    changetextcolor(" Wind", 11);
    cout << "             ";
    changetextcolor("Fire", 12);
...
void selectmonster()
{
    ...
    changetextcolor("Earth", 14);
    cout << endl;
    cout << "Choose your monstertype & element" << endl;
}
